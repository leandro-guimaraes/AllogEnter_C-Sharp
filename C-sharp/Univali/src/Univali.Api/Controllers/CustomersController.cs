...
public class CustomersController : ControllerBase
{
    ...
    CustomerForUpdateDto customerForUpdateDto)
    {
        ...
        var customerFromDatabase =  customerFromDatabase.Instance.Customers
    ...
    public ActionResult DeleteCustomer(int id)
    {
        ...
        .FirstOrDefault(customerFromDatabase => customerFromDatabase.Id == id);
    ...
    public ActionResult PartiallyUpdateCustomer(
        [FromBody] JsonPatchDocument<CustomerForPatchDto> patchDocumment, 
        [FromRoute] int id)
    {
        var customerFromDatabase = customerFromDatabase.Instance.Customers.FirstOrDefault(customerFromDatabase => customerFromDatabase.Id ==id);
        ...
        patchDocumment.ApplyTo(customerToPatch);
